...
# BASED ON /home/sen/STM32CubeIDE/workspace_abu2024/ABU2024_DriverG431
...
target_link_options(
    ...
    "$<$<NOT:$<CONFIG:Debug>>:-mfloat-abi=hard>"
    -T
    "$<$<CONFIG:Debug>:${PROJECT_SOURCE_DIR}/STM32G431K8TX_FLASH.ld>"
    "$<$<NOT:$<CONFIG:Debug>>:${PROJECT_SOURCE_DIR}/STM32G431K8TX_FLASH.ld>"
)
...
target_sources(
    ...
    "Core/Src/i2c.c"
    "Core/Src/main.c"
    "Core/Src/sh2/Adafruit_BNO08x.cpp"
